...
import { ChainFundDestinationAccount } from './fundDestinationAccount.js';
...
export function config(args: Partial<ATXPConfig> = {}): ATXPConfig {
  ...
  const config: ATXPConfig = {
    fundDestinationAccount: args.fundDestinationAccount ?? new ChainFundDestinationAccount(DESTINATION, 'base'),
